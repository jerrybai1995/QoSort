...
With our current version of SampleSort, we achieved 0.97s with sorting 10M float-64 elements on a 20-core machine (40 logical processors). We are carrying out more tests and performance tweaks along the way.