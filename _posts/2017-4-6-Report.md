...
<div class="imgcap">
<img src="/QoSort/assets/images/worker_pool_scheduling.png">
<div class="thecap">Figure 1: Optimized quicksort's worker pool scheduling and task queue</div>
</div>

<div class="imgcap">
<img src="/QoSort/assets/images/qsort_worker_logic.png">
<div class="thecap">Figure 2: Optimized quicksort's worker logic</div>
</div>
...
As was discussed above, our implementation is consistent with Golang's `sort.Interface` (see [here](https://golang.org/pkg/sort/#Interface)). This is very important, as we don't assume on the underlying data structure or element type. 

The best baseline model we found that supports generic type was only able to sort 100M float64-pairs in about 7.2 seconds (a starred open source project).
